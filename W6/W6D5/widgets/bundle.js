...
var _master_render = __webpack_require__(27);

var _master_render2 = _interopRequireDefault(_master_render);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_master_render2.default, null), root);
}); //used for React to hook into the DOM
...
var Clock = function (_React$Component) {
  ...
  return Clock;
}(_react2.default.Component); // class end
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function makeTabs() {
      ...
      return this.props.tabObjs.map(function (tab, index) {
        return _react2.default.createElement(
          "div",
          { className: "tabs", key: index, onClick: _this2.handleClick(index) },
          tab.title
        );
      });
    }
    ...
    value: function handleClick(index) {
      ...
      return function (event) {
        _this3.setState({ selectedTab: index });
      }.bind(this);
    }
  }, {
    key: "render",
    value: function render() {
      var currentTab = this.props.tabObjs[this.state.selectedTab];
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(
...
var MasterRender = function (_React$Component) {
  _inherits(MasterRender, _React$Component);

  function MasterRender() {
    _classCallCheck(this, MasterRender);

    return _possibleConstructorReturn(this, (MasterRender.__proto__ || Object.getPrototypeOf(MasterRender)).apply(this, arguments));
  }

  _createClass(MasterRender, [{
    key: 'render',
    value: function render() {
      var TABNAMES = [{ title: "one", content: "one stuff" }, { title: "two", content: "two stuff" }, { title: "three", content: "three stuff" }];

      return _react2.default.createElement(
        'div',
        { className: 'master-render' },
        _react2.default.createElement(_clock2.default, null),
        _react2.default.createElement(_tabs2.default, { tabObjs: TABNAMES })
      );
    }
    // <Weather />
