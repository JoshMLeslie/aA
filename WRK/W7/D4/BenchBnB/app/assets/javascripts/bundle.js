...
exports.receiveErrors = exports.logoutCurrentUser = exports.receiveCurrentUser = exports.logout = exports.login = exports.signup = exports.LOGOUT_CURRENT_USER = exports.RECEIVE_CURRENT_USER = undefined;
...
var signup = exports.signup = function signup(user) {
  return function (dispatch) {
    (0, _session_api_util.apiSignup)(user).then(function (user) {
...
var login = exports.login = function login(user) {
  return function (dispatch) {
    (0, _session_api_util.apiLogin)(user).then(function (user) {
      return dispatch(receiveCurrentUser(user));
    }, function (err) {
      return dispatch(receiveErrors(err.responseJSON));
    });
...
var logout = exports.logout = function logout() {
  return function (dispatch) {
    (0, _session_api_util.apiLogout)(user).then(function () {
...
var _error_reducer = __webpack_require__(/*! ./error_reducer */ "./frontend/reducers/error_reducer.js");
...
var sessionErrorReducer = function sessionErrorReducer() {
  ...
  Object.freeze(state);
  switch (action.type) {
    case _session_reducer.RECEIVE_SESSION_ERRORS:
      return action.errors;
    case _session_reducer.RECEIVE_CURRENT_USER:
      return [];
    default:
      return state;
  }
...
exports.default = sessionErrorReducer;
...
var _session_actions = __webpack_require__(/*! ../actions/session_actions.js */ "./frontend/actions/session_actions.js");
...
var apiSignup = exports.apiSignup = function apiSignup(user) {
  $.ajax({
    method: 'POST',
    url: 'api/users',
    data: { user: user }
...
var apiLogin = exports.apiLogin = function apiLogin(user) {
  $.ajax({
    method: 'POST',
    url: 'api/session',
    data: { user: user }
...
var apiLogout = exports.apiLogout = function apiLogout() {
  $.ajax({
    method: 'DELETE',
    url: 'api/session'
  });
