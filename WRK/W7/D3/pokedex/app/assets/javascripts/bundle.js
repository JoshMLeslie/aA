...
var _pokemon_item = __webpack_require__(/*! ./pokemon_item */ "./frontend/components/pokemon/pokemon_item.jsx");

var _pokemon_item2 = _interopRequireDefault(_pokemon_item);
  ...
  _createClass(PokemonIndex, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'ul',
        null,
        _react2.default.createElement(_pokemon_item2.default, { pokemon: this.props.pokemon })
      );
    }
  }]);
...
var mapStateToProps = function mapStateToProps(state) {
  return { pokemon: (0, _selectors.selectAllPokemon)(state) };
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return { requestAllPokemon: function requestAllPokemon() {
...
/***/ "./frontend/components/pokemon/pokemon_item.jsx":
/*!******************************************************!*\
  !*** ./frontend/components/pokemon/pokemon_item.jsx ***!
  \******************************************************/
/*! no static exports found */
...
exports.default = function (props) {
  return props.pokemon.map(function (pokemon) {
    return _react2.default.createElement(
      'li',
      null,
      ' ',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_root.Root, { store: store }), rootEl);
});
...
var _items_reducer = __webpack_require__(/*! ./items_reducer */ "./frontend/reducers/items_reducer.js");
...
exports.default = (0, _redux.combineReducers)({ pokemon: _pokemon_reducer2.default, items: _items_reducer2.default });
...
// NESTING FOR DAYS
exports.default = (0, _redux.combineReducers)({ entities: _entities_reducer2.default });
