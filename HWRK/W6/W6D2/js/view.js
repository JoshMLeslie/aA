...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  let temp = ("Yeah so this has been great and all");
  let temp2 = (" but I need to sleep sometime too. ");
  let temp3 = ("Okay bye.");
  $allTemp = temp.concat(temp2).concat(temp3);
  $("#easel").append("<h2>"+$allTemp+"</h2>");
};
